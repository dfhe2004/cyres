from cyres import *
from cost_functions.wrappers import SimpleCostF_2x1f8
...
problem.add_residual_block(SimpleCostF_2x1f8(f1), SquaredLoss(), [x1,x2])
problem.add_residual_block(SimpleCostF_2x1f8(f2), SquaredLoss(), [x3,x4])
problem.add_residual_block(SimpleCostF_2x1f8(f3), SquaredLoss(), [x2,x3])
problem.add_residual_block(SimpleCostF_2x1f8(f4), SquaredLoss(), [x1,x4])
